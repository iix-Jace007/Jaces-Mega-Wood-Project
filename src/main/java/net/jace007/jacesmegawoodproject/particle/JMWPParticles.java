...
public class JMWPParticles {
        ...
        public static final Supplier<FallingLeavesParticle> AGRABAH_CEDER_PARTICALES =
                PARTICLE_TYPES.register("agrabah_ceder_particles", () -> new FallingLeavesParticle(true));
