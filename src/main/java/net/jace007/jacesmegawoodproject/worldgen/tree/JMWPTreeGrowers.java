...
public class JMWPTreeGrowers {
    public static final TreeGrower AGRABAH_CEDER = new TreeGrower(JacesMegaWoodProject.MOD_ID + ":agranah_ceder",
           Optional.empty(), Optional.of(JMWPConfiguredFeatures.AGRABAH_CEDER), Optional.empty());
